...
## Usage
To use the plugin, [set up Xidi as per normal](https://github.com/samuelgr/Xidi/wiki/Getting-Started), download the [latest release of the SDL2 Plugin](https://github.com/ProjectXsent/Xidi-SDL2-Plugin/releases/latest), and place either the `SDL.XidiPlugin.32.dll` file (for a 32-bit application), or the `SDL.XidiPlugin.64.dll` (for a 64-bit application) and the appropriate `SDL2.dll` into the same directory as the application executable.
